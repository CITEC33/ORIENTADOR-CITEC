      ...
      >
        ...
        <div className='space-y-3 mb-6'>
          <p className='text-slate-300 text-xs sm:text-sm leading-relaxed'>
            El <strong className='text-violet-400'>Modo Legal</strong> activa un
            procesamiento especializado para consultas jurídicas.
          </p>
          ...
          <div className='bg-violet-500/10 border border-violet-500/20 rounded-lg p-3 space-y-2'>
            <p className='text-violet-300 text-[10px] sm:text-xs font-medium flex items-start gap-2'>
              ...
              <span>
                Ideal para dudas sobre leyes, derechos legales y procedimientos
                jurídicos
              </span>
            </p>
            <p className='text-violet-300 text-[10px] sm:text-xs font-medium flex items-start gap-2'>
              <CheckCircle className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-violet-400 mt-0.5 shrink-0' />
              <span>
                Mejora la precisión en temas de violencia familiar, órdenes de
            ...
            <p className='text-violet-300 text-[10px] sm:text-xs font-medium flex items-start gap-2'>
              <CheckCircle className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-violet-400 mt-0.5 shrink-0' />
              <span>
                Proporciona información más detallada sobre tus opciones legales
              </span>
            </p>
          </div>

          <p className='text-slate-400 text-[10px] sm:text-xs italic'>
            Puedes desactivarlo en cualquier momento desde el botón en la barra
            inferior.
          </p>
        </div>
