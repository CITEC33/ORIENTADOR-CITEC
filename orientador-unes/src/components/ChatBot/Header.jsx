...
import AiDisclaimerButton from '../AiDisclaimerButton'
    ...
    <header className='glass-strong p-2 rounded-xl mb-2 relative z-10 shrink-0'>
      ...
      <div className='flex items-center justify-between gap-2 pt-5 sm:pt-3 lg:pt-0'>
        <div className='flex items-center gap-2 sm:gap-4 min-w-0'>
          <div
            className='w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center shrink-0 overflow-hidden'
            style={{
              background: 'linear-gradient(145deg, #3b82f6, #1d4ed8)',
              boxShadow:
                '0 0 22px rgba(59,130,246,0.5), inset 0 1px 0 rgba(255,255,255,0.18)'
            }}
          >
            <AquilaAvatar
              size='lg'
          ...
          <div className='min-w-0'>
            ...
            <p className='text-xs sm:text-sm text-blue-200/75 leading-tight truncate max-w-[140px] sm:max-w-none'>
        ...
        <div className='flex items-center gap-1.5 sm:gap-3 shrink-0'>
          ...
          <AiDisclaimerButton variant='chat' />
